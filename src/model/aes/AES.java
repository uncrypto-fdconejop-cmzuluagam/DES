...
public class AES {
    ...
    public static int _128_ROUNDS = 10;
    ...
    public static final int[][] INV_GALOIS = {{0x0e, 0x0b, 0x0d, 0x09},
        {0x09, 0x0e, 0x0b, 0x0d},
        {0x0d, 0x09, 0x0e, 0x0b},
        {0x0b, 0x0d, 0x09, 0x0e}};
    ...
    public static short[] rotWord(short[] row){
        short[] rot = row.clone();
        short aux = rot[0];
        for(int i = 1; i < rot.length; i++)
            rot[i - 1] = rot[i];
        rot[rot.length - 1] = aux;
        return rot;
    }
    
    // SubBWord function based on SBOX
    public static short[] subBytesRow(short[] r){
        short[] sub = new short[r.length];
        for (int i = 0; i < sub.length; i++) {
            short b = r[i];
            int row = (b / 16), col = (b % 16);
            sub[i] = (short) AES.SBOX[row * 16 + col];
        }
        return sub;
    }
    ...
    public static short[][] subBytes(short[][] m){
        short[][] state = new short[4][];
        for (int i = 0; i < 4; i++) 
            state[i] = subBytesRow(m[i]);
        return state;
    }
